      ...
      <section className="cstl-container py-14 sm:py-16">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
          <div className="lg:col-span-7">
            ...
            <p className="mt-3 text-muted-foreground leading-relaxed">
              CSTL is the group-level layer that creates structure across operations:
        ...
        <div className="mt-10 rounded-2xl border border-border bg-card p-6">
          <div className="flex items-start gap-3">
            ...
            <div className="max-w-2xl">
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                The CSTL vibe is executive, minimal, and premium—clear typography, warm paper background,
