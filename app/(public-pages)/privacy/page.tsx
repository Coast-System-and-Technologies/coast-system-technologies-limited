        ...
        <div className="mx-auto max-w-6xl px-4 py-14 sm:py-16">
          <div className="flex flex-col gap-6">
            <div className="flex flex-wrap items-center gap-2">
              {[
                { key: "ndpa", label: "NDPA/NDPR (Nigeria)" },
                { key: "effective", label: `Effective: ${EFFECTIVE_DATE}` },
                { key: "rc", label: `RC ${SITE.trust.rc}` },
              ].map((b, idx) => (
                <RevealItem key={b.key} delay={0.02 + idx * 0.05} y={6} duration={0.35}>
                  <Badge
                    variant="secondary"
            ...
            <Reveal delay={0.1} variant="fade" duration={0.3}>
            ...
            <Reveal delay={0.12} variant="fade" duration={0.3}>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-sm leading-6 text-muted-foreground">
              {/* Each major block gets a lift; content stays identical */}
            ...
            <Reveal variant="fade" duration={0.3}>
            ...
            <Reveal variant="lift" duration={0.45} y={12}>
              <Card className="border-border/70 bg-card/70">
                ...
                <CardContent className="space-y-2 text-sm">
                  {toc.map((t, idx) => (
                    <RevealItem key={t.href} delay={0.02 + idx * 0.03} y={6} duration={0.35}>
                      <a
                        href={t.href}
              ...
              <Card className="border-border/70 bg-card/70">
                ...
                <CardContent className="space-y-2 text-sm">
                  {[
                    ...
                    <RevealItem key={x.href} delay={0.02 + idx * 0.04} y={6} duration={0.35}>
                      <Link
                        href={x.href}
                        className="block text-muted-foreground underline-offset-4 hover:text-foreground hover:underline"
                      >
